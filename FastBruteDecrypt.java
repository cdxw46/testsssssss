...
public class FastBruteDecrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Trying every 16-byte sequence (stepping by 4)...");
        
        int found = 0;
        
        // Try every 16-byte sequence, but step by 4 bytes for speed
        for (int i = 0; i <= heap.length - 16; i += 4) {
            ...
            if (i % 500000 == 0 && i > 0) {
                System.out.println("Progress: " + i + " / " + heap.length + " (" + (i*100/heap.length) + "%)");
            }
        }
        
        System.out.println("\nDone. Found " + found + " candidates.");
    }
