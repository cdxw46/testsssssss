            ...
            if (cls != null) {
                if ("RSA".equals(key.getAlgorithm())) {
                    ...
                    if (z3 && RSAPrivateCrtKeySpec.class.isAssignableFrom(cls)) {
                        ...
                        if (z4 && RSAPrivateCrtKeySpec.class.isAssignableFrom(cls)) {
                        ...
                        } else if (z4 && RSAPrivateKeySpec.class.isAssignableFrom(cls)) {
                            ...
                            throw new InvalidKeySpecException("Not a valid PKCS#8 encoding");
                        } else if (z4 && PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
                        ...
                        } else if (z2 && X509EncodedKeySpec.class.isAssignableFrom(cls)) {
