...
public final class NativeCrypto {
    ...
    static {
        ...
        if (e == null) {
            ...
            if (length % 2 == 0) {
                ...
                for (int i3 = EXTENSION_TYPE_NON_CRITICAL; i3 < length; i3 += 2) {
                    String cipherSuiteToJava = cipherSuiteToJava(strArr2[i3]);
                    SUPPORTED_TLS_1_2_CIPHER_SUITES[i3 / 2] = cipherSuiteToJava;
                    SUPPORTED_TLS_1_2_CIPHER_SUITES_SET.add(cipherSuiteToJava);
                    SUPPORTED_LEGACY_CIPHER_SUITES_SET.add(strArr2[i3 + 1]);
                }
                ...
                if (EVP_has_aes_hardware() == 1) {
                    ...
                    z2 = EXTENSION_TYPE_NON_CRITICAL;
                }
                HAS_AES_HARDWARE = z2;
            } else {
            ...
            SUPPORTED_TLS_1_2_CIPHER_SUITES = new String[EXTENSION_TYPE_NON_CRITICAL];
        }
    ...
    public static native void ASN1_TIME_to_Calendar(long j2, Calendar calendar);

    public static native byte[] ASN1_seq_pack_X509(long[] jArr);

    public static native long[] ASN1_seq_unpack_X509_bio(long j2);

    public static native void BIO_free_all(long j2);

    public static native int BIO_read(long j2, byte[] bArr);

    public static native void BIO_write(long j2, byte[] bArr, int i2, int i3);

    public static native int ECDH_compute_key(byte[] bArr, int i2, NativeRef.EVP_PKEY evp_pkey, NativeRef.EVP_PKEY evp_pkey2);
    ...
    public static native int ENGINE_SSL_do_handshake(long j2, NativeSsl nativeSsl, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native void ENGINE_SSL_force_read(long j2, NativeSsl nativeSsl, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native int ENGINE_SSL_read_BIO_direct(long j2, NativeSsl nativeSsl, long j3, long j4, int i2, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native int ENGINE_SSL_read_BIO_heap(long j2, NativeSsl nativeSsl, long j3, byte[] bArr, int i2, int i3, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native int ENGINE_SSL_read_direct(long j2, NativeSsl nativeSsl, long j3, int i2, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native void ENGINE_SSL_shutdown(long j2, NativeSsl nativeSsl, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native int ENGINE_SSL_write_BIO_direct(long j2, NativeSsl nativeSsl, long j3, long j4, int i2, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native int ENGINE_SSL_write_BIO_heap(long j2, NativeSsl nativeSsl, long j3, byte[] bArr, int i2, int i3, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native int ENGINE_SSL_write_direct(long j2, NativeSsl nativeSsl, long j3, int i2, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native int EVP_AEAD_CTX_open(long j2, byte[] bArr, int i2, byte[] bArr2, int i3, byte[] bArr3, byte[] bArr4, int i4, int i5, byte[] bArr5);

    public static native int EVP_AEAD_CTX_open_buf(long j2, byte[] bArr, int i2, ByteBuffer byteBuffer, byte[] bArr2, ByteBuffer byteBuffer2, byte[] bArr3);

    public static native int EVP_AEAD_CTX_seal(long j2, byte[] bArr, int i2, byte[] bArr2, int i3, byte[] bArr3, byte[] bArr4, int i4, int i5, byte[] bArr5);

    public static native int EVP_AEAD_CTX_seal_buf(long j2, byte[] bArr, int i2, ByteBuffer byteBuffer, byte[] bArr2, ByteBuffer byteBuffer2, byte[] bArr3);
    ...
    public static native void EVP_CIPHER_CTX_set_padding(NativeRef.EVP_CIPHER_CTX evp_cipher_ctx, boolean z2);

    public static native int EVP_CIPHER_iv_length(long j2);

    public static native int EVP_CipherFinal_ex(NativeRef.EVP_CIPHER_CTX evp_cipher_ctx, byte[] bArr, int i2);

    public static native void EVP_CipherInit_ex(NativeRef.EVP_CIPHER_CTX evp_cipher_ctx, long j2, byte[] bArr, byte[] bArr2, boolean z2);

    public static native int EVP_CipherUpdate(NativeRef.EVP_CIPHER_CTX evp_cipher_ctx, byte[] bArr, int i2, byte[] bArr2, int i3, int i4);
    ...
    public static native boolean EVP_DigestVerifyFinal(NativeRef.EVP_MD_CTX evp_md_ctx, byte[] bArr, int i2, int i3);
    ...
    public static native void EVP_PKEY_CTX_set_rsa_mgf1_md(long j2, long j3);

    public static native void EVP_PKEY_CTX_set_rsa_oaep_label(long j2, byte[] bArr);

    public static native void EVP_PKEY_CTX_set_rsa_oaep_md(long j2, long j3);

    public static native void EVP_PKEY_CTX_set_rsa_padding(long j2, int i2);

    public static native void EVP_PKEY_CTX_set_rsa_pss_saltlen(long j2, int i2);

    public static native int EVP_PKEY_cmp(NativeRef.EVP_PKEY evp_pkey, NativeRef.EVP_PKEY evp_pkey2);

    public static native int EVP_PKEY_decrypt(NativeRef.EVP_PKEY_CTX evp_pkey_ctx, byte[] bArr, int i2, byte[] bArr2, int i3, int i4);

    public static native long EVP_PKEY_decrypt_init(NativeRef.EVP_PKEY evp_pkey);

    public static native int EVP_PKEY_encrypt(NativeRef.EVP_PKEY_CTX evp_pkey_ctx, byte[] bArr, int i2, byte[] bArr2, int i3, int i4);
    ...
    public static native int RSA_private_decrypt(int i2, byte[] bArr, byte[] bArr2, NativeRef.EVP_PKEY evp_pkey, int i3);

    public static native int RSA_private_encrypt(int i2, byte[] bArr, byte[] bArr2, NativeRef.EVP_PKEY evp_pkey, int i3);

    public static native int RSA_public_decrypt(int i2, byte[] bArr, byte[] bArr2, NativeRef.EVP_PKEY evp_pkey, int i3);
    ...
    public static native long SSL_BIO_new(long j2, NativeSsl nativeSsl);
    ...
    public static native void SSL_accept_renegotiations(long j2, NativeSsl nativeSsl);
    ...
    public static native void SSL_do_handshake(long j2, NativeSsl nativeSsl, FileDescriptor fileDescriptor, SSLHandshakeCallbacks sSLHandshakeCallbacks, int i2);
    ...
    public static native void SSL_enable_tls_channel_id(long j2, NativeSsl nativeSsl);

    public static native byte[] SSL_export_keying_material(long j2, NativeSsl nativeSsl, byte[] bArr, byte[] bArr2, int i2);
    ...
    public static native byte[] SSL_get_tls_channel_id(long j2, NativeSsl nativeSsl);
    ...
    public static native long SSL_new(long j2, AbstractSessionContext abstractSessionContext);
    ...
    public static native int SSL_read(long j2, NativeSsl nativeSsl, FileDescriptor fileDescriptor, SSLHandshakeCallbacks sSLHandshakeCallbacks, byte[] bArr, int i2, int i3, int i4);
    ...
    public static native void SSL_set_client_CA_list(long j2, NativeSsl nativeSsl, byte[][] bArr);
    ...
    public static native void SSL_set_session(long j2, NativeSsl nativeSsl, long j3);

    public static native void SSL_set_session_creation_enabled(long j2, NativeSsl nativeSsl, boolean z2);
    ...
    public static native void SSL_set_tlsext_host_name(long j2, NativeSsl nativeSsl, String str);

    public static native void SSL_set_verify(long j2, NativeSsl nativeSsl, int i2);

    public static native void SSL_shutdown(long j2, NativeSsl nativeSsl, FileDescriptor fileDescriptor, SSLHandshakeCallbacks sSLHandshakeCallbacks);

    public static native void SSL_use_psk_identity_hint(long j2, NativeSsl nativeSsl, String str);

    public static native void SSL_write(long j2, NativeSsl nativeSsl, FileDescriptor fileDescriptor, SSLHandshakeCallbacks sSLHandshakeCallbacks, byte[] bArr, int i2, int i3, int i4);
    ...
    public static native void X509_CRL_verify(long j2, OpenSSLX509CRL openSSLX509CRL, NativeRef.EVP_PKEY evp_pkey);
    ...
    public static native long X509_get_pubkey(long j2, OpenSSLX509Certificate openSSLX509Certificate);
    ...
    public static native void X509_verify(long j2, OpenSSLX509Certificate openSSLX509Certificate, NativeRef.EVP_PKEY evp_pkey);
    ...
    public static native boolean asn1_read_next_tag_is(long j2, int i2);

    public static native void asn1_read_null(long j2);

    public static native byte[] asn1_read_octetstring(long j2);

    public static native String asn1_read_oid(long j2);

    public static native long asn1_read_sequence(long j2);

    public static native long asn1_read_tagged(long j2);

    public static native long asn1_read_uint64(long j2);

    public static native void asn1_write_cleanup(long j2);

    public static native byte[] asn1_write_finish(long j2);

    public static native void asn1_write_flush(long j2);

    public static native void asn1_write_free(long j2);

    public static native long asn1_write_init();

    public static native void asn1_write_null(long j2);

    public static native void asn1_write_octetstring(long j2, byte[] bArr);

    public static native void asn1_write_oid(long j2, String str);

    public static native long asn1_write_sequence(long j2);

    public static native long asn1_write_tag(long j2, int i2);

    public static native void asn1_write_uint64(long j2, long j3);
    ...
    public static String[] checkEnabledCipherSuites(String[] strArr) {
        if (strArr != null) {
            for (int i2 = EXTENSION_TYPE_NON_CRITICAL; i2 < strArr.length; i2++) {
                String str = strArr[i2];
                if (str != null) {
                    if (!str.equals(TLS_EMPTY_RENEGOTIATION_INFO_SCSV) && !strArr[i2].equals(TLS_FALLBACK_SCSV) && !SUPPORTED_TLS_1_2_CIPHER_SUITES_SET.contains(strArr[i2]) && !SUPPORTED_LEGACY_CIPHER_SUITES_SET.contains(strArr[i2])) {
                        throw new IllegalArgumentException("cipherSuite " + strArr[i2] + " is not supported.");
                    }
                } else {
                    throw new IllegalArgumentException(e.b("cipherSuites[", i2, "] == null"));
                }
            }
            return strArr;
        }
    ...
    public static String[] checkEnabledProtocols(String[] strArr) {
        if (strArr != null) {
            ...
            for (int i2 = EXTENSION_TYPE_NON_CRITICAL; i2 < length; i2++) {
                String str = strArr[i2];
                if (str != null) {
                    if (!str.equals(SUPPORTED_PROTOCOL_TLSV1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_2) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_3) && !str.equals(OBSOLETE_PROTOCOL_SSLV3)) {
                        throw new IllegalArgumentException(e.d("protocol ", str, " is not supported"));
                    }
                } else {
    ...
    public static native long create_BIO_InputStream(OpenSSLBIOInputStream openSSLBIOInputStream, boolean z2);

    public static native long create_BIO_OutputStream(OutputStream outputStream);

    public static native long[] d2i_PKCS7_bio(long j2, int i2);
    ...
    private static int getProtocolConstant(String str) {
        ...
        throw new AssertionError("Unknown protocol encountered: ".concat(str));
    }

    private static Range getProtocolRange(String[] strArr) {
        List asList = Arrays.asList(strArr);
        String str = null;
        int i2 = EXTENSION_TYPE_NON_CRITICAL;
        String str2 = null;
        while (true) {
    ...
    public static native Object[][] get_X509_GENERAL_NAME_stack(long j2, OpenSSLX509Certificate openSSLX509Certificate, int i2);
    ...
    public static native void setApplicationProtocols(long j2, NativeSsl nativeSsl, boolean z2, byte[] bArr);
    ...
    public static native void setHasApplicationProtocolSelector(long j2, NativeSsl nativeSsl, boolean z2);

    public static native void setLocalCertsAndPrivateKey(long j2, NativeSsl nativeSsl, byte[][] bArr, NativeRef.EVP_PKEY evp_pkey);

    public static native void set_SSL_psk_client_callback_enabled(long j2, NativeSsl nativeSsl, boolean z2);

    public static native void set_SSL_psk_server_callback_enabled(long j2, NativeSsl nativeSsl, boolean z2);
    ...
    private static int X509_NAME_hash(X500Principal x500Principal, String str) {
        try {
            ...
            return ((digest[3] & 255) << 24) | (digest[EXTENSION_TYPE_NON_CRITICAL] & 255) | ((digest[1] & 255) << 8) | ((digest[2] & 255) << 16);
