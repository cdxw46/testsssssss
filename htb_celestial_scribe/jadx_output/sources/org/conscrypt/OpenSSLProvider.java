...
public final class OpenSSLProvider extends Provider {
    ...
    private void putECDHKeyAgreementImplClass(String str) {
        ...
        putImplClassWithKeyConstraints("KeyAgreement.ECDH", e.c(str2, str), sb.toString(), "PKCS#8");
    }
    ...
    private void putMacImplClass(String str, String str2) {
        ...
        putImplClassWithKeyConstraints("Mac." + str, e.c(str3, str2), sb2, "RAW");
    }
    ...
    private void putRAWRSASignatureImplClass(String str) {
        ...
        putImplClassWithKeyConstraints("Signature.NONEwithRSA", e.c(str2, str), sb.toString(), null);
    }
    ...
    private void putRSACipherImplClass(String str, String str2) {
        ...
        sb.append("OpenSSLRSAPublicKey|java.security.interfaces.RSAPublicKey");
        String sb2 = sb.toString();
        putImplClassWithKeyConstraints("Cipher." + str, e.c(str3, str2), sb2, null);
    }
    ...
    private void putSignatureImplClass(String str, String str2) {
        ...
        String sb2 = sb.toString();
        putImplClassWithKeyConstraints("Signature." + str, e.c(str3, str2), sb2, "PKCS#8|X.509");
    }
    ...
    public OpenSSLProvider(String str, boolean z2, String str2) {
        ...
        if (str2.equals("TLSv1.2")) {
            str3 = "$TLSv12";
        } else if (!str2.equals("TLSv1.3")) {
            throw new IllegalArgumentException("Choice of default protocol is unsupported: ".concat(str2));
        } else {
            str3 = "$TLSv13";
        }
        ...
        sb3.append(str4);
        e.g(sb3, "DefaultSSLContextImpl", str3, this, "SSLContext.Default");
        if (z2) {
        ...
        StringBuilder e2 = e.e(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.22", "AES", "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.42", "AES");
        e2.append(str4);
        e2.append("IvParameters$ChaCha20");
        put("AlgorithmParameters.ChaCha20", e2.toString());
        e.g(new StringBuilder(), str4, "IvParameters$DESEDE", this, "AlgorithmParameters.DESEDE");
        e.g(e.e(this, "Alg.Alias.AlgorithmParameters.TDEA", "DESEDE", "Alg.Alias.AlgorithmParameters.1.2.840.113549.3.7", "DESEDE"), str4, "GCMParameters", this, "AlgorithmParameters.GCM");
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.6", "GCM");
        StringBuilder e3 = e.e(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.26", "GCM", "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.46", "GCM");
        e3.append(str4);
        e3.append("OAEPParameters");
        put("AlgorithmParameters.OAEP", e3.toString());
        put("AlgorithmParameters.PSS", str4 + "PSSParameters");
        put("AlgorithmParameters.EC", str4 + "ECParameters");
        e.g(new StringBuilder(), str4, "OpenSSLMessageDigestJDK$SHA1", this, "MessageDigest.SHA-1");
        put("Alg.Alias.MessageDigest.SHA1", "SHA-1");
        e.g(e.e(this, "Alg.Alias.MessageDigest.SHA", "SHA-1", "Alg.Alias.MessageDigest.1.3.14.3.2.26", "SHA-1"), str4, "OpenSSLMessageDigestJDK$SHA224", this, "MessageDigest.SHA-224");
        e.g(e.e(this, "Alg.Alias.MessageDigest.SHA224", "SHA-224", "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.4", "SHA-224"), str4, "OpenSSLMessageDigestJDK$SHA256", this, "MessageDigest.SHA-256");
        e.g(e.e(this, "Alg.Alias.MessageDigest.SHA256", "SHA-256", "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.1", "SHA-256"), str4, "OpenSSLMessageDigestJDK$SHA384", this, "MessageDigest.SHA-384");
        e.g(e.e(this, "Alg.Alias.MessageDigest.SHA384", "SHA-384", "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.2", "SHA-384"), str4, "OpenSSLMessageDigestJDK$SHA512", this, "MessageDigest.SHA-512");
        e.g(e.e(this, "Alg.Alias.MessageDigest.SHA512", "SHA-512", "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.3", "SHA-512"), str4, "OpenSSLMessageDigestJDK$MD5", this, "MessageDigest.MD5");
        put("Alg.Alias.MessageDigest.1.2.840.113549.2.5", "MD5");
        put("KeyGenerator.ARC4", str4 + "KeyGeneratorImpl$ARC4");
        StringBuilder e4 = e.e(this, "Alg.Alias.KeyGenerator.RC4", "ARC4", "Alg.Alias.KeyGenerator.1.2.840.113549.3.4", "ARC4");
        e4.append(str4);
        e4.append("KeyGeneratorImpl$AES");
        put("KeyGenerator.AES", e4.toString());
        put("KeyGenerator.ChaCha20", str4 + "KeyGeneratorImpl$ChaCha20");
        e.g(new StringBuilder(), str4, "KeyGeneratorImpl$DESEDE", this, "KeyGenerator.DESEDE");
        ...
        e.g(e.e(this, "Alg.Alias.KeyGenerator.HMAC-MD5", "HmacMD5", "Alg.Alias.KeyGenerator.HMAC/MD5", "HmacMD5"), str4, "KeyGeneratorImpl$HmacSHA1", this, "KeyGenerator.HmacSHA1");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.7", "HmacSHA1");
        put("Alg.Alias.KeyGenerator.1.3.6.1.5.5.8.1.2", "HmacSHA1");
        e.g(e.e(this, "Alg.Alias.KeyGenerator.HMAC-SHA1", "HmacSHA1", "Alg.Alias.KeyGenerator.HMAC/SHA1", "HmacSHA1"), str4, "KeyGeneratorImpl$HmacSHA224", this, "KeyGenerator.HmacSHA224");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.8", "HmacSHA224");
        e.g(e.e(this, "Alg.Alias.KeyGenerator.HMAC-SHA224", "HmacSHA224", "Alg.Alias.KeyGenerator.HMAC/SHA224", "HmacSHA224"), str4, "KeyGeneratorImpl$HmacSHA256", this, "KeyGenerator.HmacSHA256");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.9", "HmacSHA256");
        put("Alg.Alias.KeyGenerator.2.16.840.1.101.3.4.2.1", "HmacSHA256");
        e.g(e.e(this, "Alg.Alias.KeyGenerator.HMAC-SHA256", "HmacSHA256", "Alg.Alias.KeyGenerator.HMAC/SHA256", "HmacSHA256"), str4, "KeyGeneratorImpl$HmacSHA384", this, "KeyGenerator.HmacSHA384");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.10", "HmacSHA384");
        e.g(e.e(this, "Alg.Alias.KeyGenerator.HMAC-SHA384", "HmacSHA384", "Alg.Alias.KeyGenerator.HMAC/SHA384", "HmacSHA384"), str4, "KeyGeneratorImpl$HmacSHA512", this, "KeyGenerator.HmacSHA512");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.11", "HmacSHA512");
        e.g(e.e(this, "Alg.Alias.KeyGenerator.HMAC-SHA512", "HmacSHA512", "Alg.Alias.KeyGenerator.HMAC/SHA512", "HmacSHA512"), str4, "OpenSSLRSAKeyPairGenerator", this, "KeyPairGenerator.RSA");
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.1", "RSA");
        e.g(e.e(this, "Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.7", "RSA", "Alg.Alias.KeyPairGenerator.2.5.8.1.1", "RSA"), str4, "OpenSSLECKeyPairGenerator", this, "KeyPairGenerator.EC");
        e.g(e.e(this, "Alg.Alias.KeyPairGenerator.1.2.840.10045.2.1", "EC", "Alg.Alias.KeyPairGenerator.1.3.133.16.840.63.0.2", "EC"), str4, "OpenSSLRSAKeyFactory", this, "KeyFactory.RSA");
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.1", "RSA");
        e.g(e.e(this, "Alg.Alias.KeyFactory.1.2.840.113549.1.1.7", "RSA", "Alg.Alias.KeyFactory.2.5.8.1.1", "RSA"), str4, "OpenSSLECKeyFactory", this, "KeyFactory.EC");
        e.g(e.e(this, "Alg.Alias.KeyFactory.1.2.840.10045.2.1", "EC", "Alg.Alias.KeyFactory.1.3.133.16.840.63.0.2", "EC"), str4, "DESEDESecretKeyFactory", this, "SecretKeyFactory.DESEDE");
        ...
        e.g(e.e(this, "Alg.Alias.Mac.HMAC/SHA512", "HmacSHA512", "Alg.Alias.Mac.PBEWITHHMACSHA512", "HmacSHA512"), str4, "OpenSSLX509CertificateFactory", this, "CertificateFactory.X509");
