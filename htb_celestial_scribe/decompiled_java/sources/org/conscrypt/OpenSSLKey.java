...
public final class OpenSSLKey {
    ...
    public OpenSSLKey(long j2, boolean z2) {
        this(j2, z2, false);
    }

    public OpenSSLKey(long j2, boolean z2, boolean z3) {
        this.ctx = new NativeRef.EVP_PKEY(j2);
        this.wrapped = z2;
        this.hardwareBacked = z3;
    }

    public static PrivateKey getPrivateKey(PKCS8EncodedKeySpec pKCS8EncodedKeySpec, int i2) {
        try {
    ...
    public static PublicKey getPublicKey(X509EncodedKeySpec x509EncodedKeySpec, int i2) {
        try {
