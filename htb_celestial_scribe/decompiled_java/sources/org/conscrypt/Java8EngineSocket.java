...
public final class Java8EngineSocket extends ConscryptEngineSocket {
    ...
    public Java8EngineSocket(String str, int i2, SSLParametersImpl sSLParametersImpl) {
        super(str, i2, sSLParametersImpl);
    }

    public Java8EngineSocket(InetAddress inetAddress, int i2, SSLParametersImpl sSLParametersImpl) {
        super(inetAddress, i2, sSLParametersImpl);
    }

    public Java8EngineSocket(String str, int i2, InetAddress inetAddress, int i3, SSLParametersImpl sSLParametersImpl) {
        super(str, i2, inetAddress, i3, sSLParametersImpl);
    }

    public Java8EngineSocket(InetAddress inetAddress, int i2, InetAddress inetAddress2, int i3, SSLParametersImpl sSLParametersImpl) {
        super(inetAddress, i2, inetAddress2, i3, sSLParametersImpl);
    }

    public Java8EngineSocket(Socket socket, String str, int i2, boolean z2, SSLParametersImpl sSLParametersImpl) {
