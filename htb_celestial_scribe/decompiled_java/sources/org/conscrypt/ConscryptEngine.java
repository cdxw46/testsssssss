...
public final class ConscryptEngine extends AbstractConscryptEngine implements NativeCrypto.SSLHandshakeCallbacks, SSLParametersImpl.AliasChooser, SSLParametersImpl.PSKCallbacks {
            ...
            try {
                try {
                    ...
                    if (e2.getMessage().contains("unexpected CCS")) {
                        ...
                        Platform.logEvent("ssl_unexpected_ccs: host=" + peerHost);
                    }
                    closeAll();
    ...
    private static int calcDstsLength(ByteBuffer[] byteBufferArr, int i2, int i3) {
        ...
        for (int i5 = 0; i5 < byteBufferArr.length; i5++) {
            ...
            Preconditions.checkArgument(z2, "dsts[%d] is null", Integer.valueOf(i5));
    ...
    private static long calcSrcsLength(ByteBuffer[] byteBufferArr, int i2, int i3) {
        ...
        while (i2 < i3) {
            ...
            if (byteBuffer != null) {
                ...
                throw new IllegalArgumentException(e.b("srcs[", i2, "] is null"));
            }
        }
        return j2;
    }
    ...
    public String getHostname() {
        ...
        if (str == null) {
            return this.peerInfoProvider.getHostname();
        }
        return str;
    }
    ...
    public String getPeerHost() {
        String str = this.peerHostname;
        if (str == null) {
            return this.peerInfoProvider.getHostnameOrIP();
        }
        return str;
    }
    ...
    public boolean isInboundDone() {
        ...
        synchronized (this.ssl) {
            try {
                ...
                z2 = pendingInboundCleartextBytes() == 0 ? true : true;
                z2 = false;
            } finally {
            }
        }
    ...
    public boolean isOutboundDone() {
        ...
        synchronized (this.ssl) {
            try {
                ...
                z2 = pendingOutboundEncryptedBytes() == 0 ? true : true;
                z2 = false;
            } finally {
            }
        }
    ...
    public void setHostname(String str) {
        ...
        sSLParametersImpl.setUseSni(z2);
    ...
    public SSLEngineResult wrap(ByteBuffer[] byteBufferArr, int i2, int i3, ByteBuffer byteBuffer) {
        ...
        int i6 = i2 + i3;
        Preconditions.checkPositionIndexes(i2, i6, byteBufferArr.length);
        if (!byteBuffer.isReadOnly()) {
                ...
                try {
                    ...
                    if (i7 != 0) {
                        ...
                        if (min > 0) {
                            ...
                            i5 = writePlaintextData(bufferLargerThan, Math.min(16384, bufferLargerThan.remaining()));
                            if (i5 > 0) {
                                if (z2) {
                                    BufferUtils.consume(byteBufferArr, i5);
                                }
                                SSLEngineResult readPendingBytesFromBIO3 = readPendingBytesFromBIO(byteBuffer, i5, 0, handshakeStatus);
                                if (readPendingBytesFromBIO3 == null) {
                                    i4 = 0;
                                } else if (readPendingBytesFromBIO3.getStatus() != SSLEngineResult.Status.OK) {
                                    return readPendingBytesFromBIO3;
                                } else {
                                    i4 = readPendingBytesFromBIO3.bytesProduced();
                                }
                            } else {
                                int error = this.ssl.getError(i5);
                                if (error == 2) {
                        ...
                        return (i5 != 0 || (readPendingBytesFromBIO = readPendingBytesFromBIO(byteBuffer, 0, i4, handshakeStatus)) == null) ? newResult(i5, i4, handshakeStatus) : readPendingBytesFromBIO;
                    }
    ...
    public SSLEngineResult unwrap(ByteBuffer[] byteBufferArr, int i2, int i3, ByteBuffer[] byteBufferArr2, int i4, int i5) {
        ...
        Preconditions.checkArgument(byteBufferArr2 != null, "dsts is null");
        int i9 = i3 + i2;
        Preconditions.checkPositionIndexes(i2, i9, byteBufferArr.length);
        int i10 = i4 + i5;
        Preconditions.checkPositionIndexes(i4, i10, byteBufferArr2.length);
        int calcDstsLength = calcDstsLength(byteBufferArr2, i4, i5);
        long calcSrcsLength = calcSrcsLength(byteBufferArr, i2, i9);
        synchronized (this.ssl) {
            try {
                int i11 = this.state;
                if (i11 != 0) {
                    ...
                    if (calcDstsLength > 0) {
                        ...
                        while (i4 < i10) {
                            try {
                                ...
                                r1 = i8;
                                return newResult(i7, r1, handshakeStatus);
                            }
                        }
                    } else {
                        try {
